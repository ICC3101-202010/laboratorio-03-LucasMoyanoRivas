...
namespace TercerLaboratorio
{
    public class Supervisores : Persona,IChangeJob, IChangeSalary, IChangeWorkingHours
    {
        ...
        private string job;
        private int hours;
        public Supervisores(int sueldo, string job, int hours, string nombre, string apellido, string rut, string fecha_de_nacimiento, string nacionalidad) : base(nombre, apellido, rut, fecha_de_nacimiento, nacionalidad)
        {
            this.sueldo = sueldo;
            this.job = job;
            this.hours = hours;
